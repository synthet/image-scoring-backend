#!/usr/bin/env python3
"""
Simple MUSIQ Image Gallery Generator
Usage: python gallery_generator.py "C:\Path\To\Your\Images"
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python gallery_generator.py <directory_path>")
        print("Example: python gallery_generator.py \"D:\\Photos\\Export\\2025\"")
        return

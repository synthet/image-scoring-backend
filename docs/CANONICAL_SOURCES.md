...
| MCP tools and agent workflows | [AGENTS.md](../AGENTS.md), [technical/MCP_SEARCH_DISPATCH.md](technical/MCP_SEARCH_DISPATCH.md), [mcp/action_registry.json](../mcp/action_registry.json), [.agent/mcp_tools_reference.md](../.agent/mcp_tools_reference.md), [docs/technical/MCP_DEBUGGING_TOOLS.md](technical/MCP_DEBUGGING_TOOLS.md), [modules/mcp_server.py](../modules/mcp_server.py) |
...
| Design system (palette, icons, token package) | [image-scoring-ui docs/DESIGN_SYSTEM.md](https://github.com/synthet/image-scoring-ui/blob/main/docs/DESIGN_SYSTEM.md), npm package `@synthet/image-scoring-design` **1.2.x** ([image-scoring-ui](https://github.com/synthet/image-scoring-ui)); [UX_UI_CONSTITUTION.md](https://github.com/synthet/image-scoring-ui/blob/main/docs/UX_UI_CONSTITUTION.md) (shared principles); local pointers [design/DESIGN_SYSTEM.md](design/DESIGN_SYSTEM.md), [design/UX_UI_CONSTITUTION.md](design/UX_UI_CONSTITUTION.md); consumers: backend `frontend/` (Tailwind), gallery `src/styles/tokens.css` (CSS Modules), Gradio `gradio-snippet.css` |

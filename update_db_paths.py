...
After running fix_backup_structure.py --execute on D:\\Photos\\D90 or D:\\Photos\\D300,
...
Usage:
    python update_db_paths.py [--dry-run] logs/<logfile.log> [logs/<logfile2.log> ...]

Examples:
    python update_db_paths.py --dry-run logs/fix_metadata_execute_D90_20260301_...log
    python update_db_paths.py logs/fix_metadata_execute_D90_...log logs/fix_metadata_execute_D300_...log
"""
...
# Make sure project root is on path so modules.db can be imported
